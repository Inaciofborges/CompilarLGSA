#!/usr/bin/env python3
"""
Script para compilar dados de poços a partir de arquivos Excel (Versão Extended).
...
def compile_well_data(input_folder, output_file=None):
    ...
    if output_file is None:
        if well_name:
            output_file = f"{well_name}_LGSA_Extended.csv"
        else:
            output_file = 'compiled_wells_extended.csv'
...
if __name__ == '__main__':
    print("=" * 60)
    print("Script de Compilação de Dados de Poços (Extended)")
    print("=" * 60)
